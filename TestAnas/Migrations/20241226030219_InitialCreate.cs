    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CycleVaccine", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CycleVaccine_Cycles_CycleId",
                        column: x => x.CycleId,
                        principalTable: "Cycles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CycleVaccine_Vaccines_VaccineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CycleVaccine_CycleId",
                table: "CycleVaccine",
                column: "CycleId");

            migrationBuilder.CreateIndex(
                name: "IX_CycleVaccine_VaccineId",
                table: "CycleVaccine",
                column: "VaccineId");
